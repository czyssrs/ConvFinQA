...
from general_utils import table_row_to_text, cleanhtml, str_to_num, process_row, reprog_to_seq
from general_utils import eval_program, equal_program, evaluate_result, program_tokenization
...
if __name__ == '__main__':
    ...
    # test = program_tokenization("53.2")
    # print(test)

    # print(equal_program(['34', 'EOF'], ['35', 'EOF']))
    # print(eval_program(['34', 'EOF'], None))